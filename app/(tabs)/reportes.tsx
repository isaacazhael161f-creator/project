            ...
            <View style={styles.alertsList}>
              ...
              <View style={styles.alertItem}>
                ...
                <View style={styles.alertContent}>
                  ...
                  <Text style={styles.alertDescription}>87% de vuelos a tiempo</Text>
                </View>
              </View>
              ...
              <View style={styles.alertItem}>
                ...
                <View style={styles.alertContent}>
                  <Text style={styles.alertTitle}>Slot crítico próximo</Text>
                  <Text style={styles.alertDescription}>Revisar vuelo AM205 - 16:30</Text>
                </View>
              </View>
            </View>
          </View>
